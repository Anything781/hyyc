    ...
    for k in range(36):
        ...
        for i in range(0, 24, 4):
            for j in range(0, 72, 4):
                ...
                r = np.random.rand(4, 4) #每次循环生成一组4*4随机值，共6*18组
                ...
                bb = int(j / 4)
                influence[k, aa, bb] = y
    print('inpv1:',inpv1[35,0,20:24,68:72])
    print('6x1800:')
    print('inpv2:',inpv2[35,0,20:24,68:72])
    influence.astype('float32').tofile('/mnt/disturbinput/addrandom6x1800.gdat')

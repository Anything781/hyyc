...
setenv conf 30         # Number of conv. features
setenv hidf 30         # Number of hidden neurons

setenv GGG 0                       # GPU number (0~3)
setenv ENN 10                      # Ensemble number

setenv SMF 'SODA.input.36mon.1871_1970.nc'         # Sample of training data
setenv LBF 'SODA.label.12mon.1873_1972.nc'                 # Label of training data
setenv EVD 'GODAS.input.36mon.1980_2015.nc'         # Sample of evaluation data
setenv EBD 'GODAS.label.12mon.1982_2017.nc'       # Label of training data

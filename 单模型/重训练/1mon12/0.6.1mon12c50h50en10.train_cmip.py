...
#tf.squared_difference返回平方差（有多个），tf.reduce_mean计算均值，总的来说就是均方差mse
...
with tf.Session(config=config) as sess:
    ...
    save_path = saver.save(sess,'/mnt/grad/retrain1mon12c50h50en10/'+str(beishu)+'/model.ckpt')
    print(condition)

...
'''1x1'''
for i in range(4):
  a1=np.fromfile('/mnt/gradcam/1mon12/'+CH_list[i]+'ENmeangradcamabs.gdat',dtype=np.float32)
  a1 = a1.reshape(36,18,6)
  tmp1[i] = a1

tmp1 = np.mean(tmp1,axis=0)
tmp1.astype('float32').tofile('/mnt/gradcam/1mon12/allCHgradcammeanabs.gdat')

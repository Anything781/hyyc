...
with tf.Session(config=config) as sess:     
    ...
    for i in range(10): # EN10
        ...
        saver.restore(sess, '/mnt/output/nino34_2month_12_Transfer_20/chlist/EN' + str(i + 1) + '/model.ckpt')
        '''
    ...
    en_mean.astype('float32').tofile('/mnt/gradcam/2mon12/chlistENmeangradcam.gdat')

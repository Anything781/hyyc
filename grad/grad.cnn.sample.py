...
with tf.Session(config=config) as sess:
    ...
    grad3.astype('float32').tofile('/mnt/retrain/lmont/grad/chlistgradmeandel0.gdat')
                                  #/mnt/retrain/1mon1/grad/
    grad_all_mean.astype('float32').tofile('/mnt/retrain/lmont/grad/chlistgradmean.gdat')

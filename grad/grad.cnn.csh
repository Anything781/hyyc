...
mkdir -p $HHH/retrain/$MOD/$TYP                    #mnt/retrain/1mon1/grad，把梯度结果放在grad文件夹下
		
mkdir -p $HHH/retrain/$MOD/$TYP/src

cd $HHH/retrain/$MOD/$TYP/src		    			#/mnt/retrain/1mon1/transfer/src
cp -f $HHH/retrain/grad.cnn.sample .				#这里要提前把训练代码放在retrain文件夹下
...
#计算4种模型的平均梯度
#现在还在 /mnt/retrain/1mon1/transfer/src/目录下
cd $HHH/retrain/$MOD/$TYP/src

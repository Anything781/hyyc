...
with tf.Session(config=config) as sess:
    ...
    for i in range(20,75,5):
        ...
        ii = ii - 4
        result[ii,:] = tmp
    result.astype('float32').tofile('/mnt/retrain0.2.0.7/lmont/transfer/chlistresult.gdat')

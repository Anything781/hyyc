...
setenv RET 'retraingradcam'					#重训练文件夹
...
cp -f $HHH/$RET/$MOD/retrain.cmip.sample .					#这里要提前把训练代码放在retraingradcam文件夹下
...
cp -f $HHH/$RET/$MOD/retrain.transfer.sample .				#这里要提前把训练代码放在retraingradcam文件夹下
...
cp -f $HHH/$RET/$MOD/retrain.valid.sample .				 #这里要提前把训练代码放在retraingradcam文件夹下
...
cp -f $HHH/$RET/$MOD/retrain.validmean.sample .			 #这里要提前把训练代码放在retraingradcam文件夹下

...
cp -f $HHH/$RET/retrain.cmip.sample .					#这里要提前把训练代码放在retraindisturbto0文件夹下
...
cp -f $HHH/$RET/retrain.transfer.sample .				#这里要提前把训练代码放在retraindisturbto0文件夹下
...
cp -f $HHH/$RET/retrain.valid.sample .				 #这里要提前把训练代码放在retraindisturbto0文件夹下
...
cp -f $HHH/$RET/retrain.validmean.sample .			 #这里要提前把训练代码放在retraindisturbto0文件夹下

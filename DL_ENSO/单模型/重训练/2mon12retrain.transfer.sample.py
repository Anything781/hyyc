...
with tf.Session(config=config) as sess:
    saver.restore(sess,'/mnt/retrain/lmont/cmip/chlist/0.'+str(multiple)+'/model.ckpt')
    ...
    save_path = saver.save(sess,'/mnt/retrain/lmont/transfer/chlist/0.'+str(multiple)+'/model.ckpt')
                                #mnt/retrain/2mon12/transfer/c30h30/0.1
    print(condition)

...
cp -f $HHH/retrain/3mon10retrain.valid.sample .  #这里要提前把训练代码放在retrain文件夹下
...
cp -f $HHH/retrain/3mon10retrain.validmean.sample .			#这里要提前把训练代码放在retrain文件夹下

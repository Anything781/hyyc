...
with tf.Session(config=config) as sess:
    ...
    #初始化模型
    #grad100 = np.zeros((100, 72, 24))  # test_size是第一维的个数(100,72,24)
    #grad2961 = np.zeros((2961, 72, 24))
    ...
    # grads是列表 （1,100,72,24,6） 加【0】取后四维
    ...
    grad100 = grads_x_mean

    #for kk in range(2961):
    ...
    #print('grads_mean_shape',grads_mean.shape)
    grad2961 = grads_x_cmip_mean
...
grad100.astype('float32').tofile('/mnt/grad/grad1001mon12c50h50en10.gdat')
grad2961.astype('float32').tofile('/mnt/grad/grad29611mon12c50h50en10.gdat')
grad_all_mean.astype('float32').tofile('/mnt/grad/gradmean1mon12c50h50en10.gdat')

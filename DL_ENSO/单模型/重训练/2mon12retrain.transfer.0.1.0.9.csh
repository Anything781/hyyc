...
mkdir -p $HHH/retrain/$MOD/$TYP/$opname/0.$bei				#mnt/retrain/2mon12/transfer/C30H30/0.1
mkdir -p $HHH/retrain/$MOD/$TYP/src/$opname

cd $HHH/retrain/$MOD/$TYP/src/$opname

cp -f $HHH/retrain/2mon12retrain.transfer.sample .  #这里要提前把训练代码放在1mon12文件夹下

# make layer
sed "s/chlist/$opname/g"						2mon12retrain.transfer.sample > tmp1
...
sed "s/multiple/$bei/g"                         tmp2 > 2mon12retrain.transfer.py

python 2mon12retrain.transfer.py

...
#把加载模型放在循环外看结果是否不一样
    influence = np.zeros((36, 6, 12, 36), dtype=np.float32)
    ...
    influence.astype('float32').tofile('/mnt/disturbinput/1month12to0/2x2/chlistENmemberdisturbto0.gdat')

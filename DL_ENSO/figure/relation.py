...
ipth1 = 'E:/hyyc/retrain/retrainmul/allretrainresult/'
ipth2 = 'E:/hyyc/retrain/retrainmul/'
...
cnn = open(ipth1 + lmont+'CHmeanresult.gdat', 'r')
...
plt.title('1month1 nino3.4 delheatmap', fontsize=8)
plt.xlabel('Year', fontsize=7)
plt.ylabel('Nino3.4', fontsize=7)

plt.savefig(ipth2+'1mon1retrain'+'.jpg', dpi=200)
plt.close()

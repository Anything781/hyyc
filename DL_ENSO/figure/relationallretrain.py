...
for t in range(12):
    for leadmonth in range(23):
        ...
        ipth = 'E:/hyyc/retrain0.2-0.7/整合相关性/'        #保存重训练相关性系数文件夹
        ipth1 = 'E:/hyyc/retrain0.2-0.7/整合allretrainresult/'      #重训练结果文件夹
        ...
        lines = plt.plot(x, relation, 'black')#y, sin, 'dodgerblue'
        my_plot = plt.gca()
        ...
        plt.ylim([-1, 1])
        x_tick = [0.1,0.2,0.25,0.3,0.325,0.35,0.375,0.4,0.425,0.45,0.475,0.5,0.525,0.55,0.575,0.6,0.625,0.65 ,0.675,0.7,0.8,0.9]

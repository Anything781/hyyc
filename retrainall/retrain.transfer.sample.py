...
beishu = multiple * 0.01   #乘0.1还是0.01取决于.csh文件中bei步长是多少
...
with tf.Session(config=config) as sess:
    saver.restore(sess,'/mnt/retrain0.2.0.7/lmont/cmip/chlist/0.'+str(multiple)+'/model.ckpt')
    ...
    save_path = saver.save(sess,'/mnt/retrain0.2.0.7/lmont/transfer/chlist/0.'+str(multiple)+'/model.ckpt')
                                #mnt/retrain0.2.0.7/1mon1/transfer/c30h30/0.1
    print(condition)

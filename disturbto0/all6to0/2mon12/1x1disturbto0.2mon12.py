...
#把加载模型放在循环外看结果是否不一样
    influence = np.zeros((36, 24, 72), dtype=np.float32)
...
#for a in range(6):
   #加载模型原来在这里
    ...
    influence.astype('float32').tofile('/mnt/disturbinput/2month12to0/1x1all6to0/chlistENmemberdisturbto0.gdat')

print('1x1 chlist complete')

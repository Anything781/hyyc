...
cp -f $HHH/disturbinput/1x1disturbto0.1mon12.sample .

# make layer
sed "s/member/$ens/g"					  1x1disturbto0.1mon12.sample > tmp1
sed "s/convfilter/$conf/g"							tmp1 > tmp2
sed "s/hiddfilter/$hidf/g"                          tmp2 > tmp1
sed "s/chlist/$opname/g"                            tmp1 > 1x1disturbto0.1mon12.py


python 1x1disturbto0.1mon12.py

...
#把加载模型放在循环外看结果是否不一样
    influence = np.zeros((36, 6, 6, 18), dtype=np.float32)
    ...
    influence.astype('float32').tofile('/mnt/disturbinput/1month12to0/4x4/chlistENmemberdisturbto0.gdat')

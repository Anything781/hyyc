...
# Open CNN (1981-2017)
f = open(r'E:\海洋预测\enso\DL_ENSO-1.0\CNN - 副本\output\nino34_18month_12\combination.gdat', 'r')
# /home/jhkim/cnn/output/ver4f_18month_SODA/combination.gdat
cnn = np.fromfile(f, dtype=np.float32)  # 555 cnn

# Open New SINTEX (1984-2017)             555
f = open(r'E:\海洋预测\enso\DL_ENSO-1.0\CNN - 副本\output\nino34_18month_12\combination.gdat', 'r')
#/home/jhkim/data/SINTEX_ensemble2/prediction_em/nino3.4/nino3.4.18month_12.gdat
sin = np.fromfile(f, dtype=np.float32)

# Open observation (GODAS, 1981-2017)      555
f = Dataset(r'E:\海洋预测\enso\input\input\GODAS.input.36mon.1980_2015.nc', 'r')
#/home/jhkim/data/GODAS/godas.nino.1981_2017.nc
...
# open SST & HC map   用到了chimera
f = Dataset(r'E:\海洋预测\enso\input\input\GODAS.input.36mon.1980_2015.nc', 'r')
# /home/jhkim/data/GODAS/godas.sst_t300.1980_2017.144x73.nc
...
for i in range(4):
    f = open(r'E:\海洋预测\enso\output_heatmap_MJJ\nino34_18month_12_Transfer_20\C30H30\heatmap.gdat', 'r')
    #/home/jhkim/analysis/heatmap-ver4f_18month_SODA/each_case/' + CH_list[i] + '/heatmap.gdat
...
plt.legend(('Observation', 'CNN(Cor=' + str(cor_cnn) + ')', 'SINTEX-F(Cor=' + str(cor_sin) + ')'), loc='upper right',
           prop={'size': 7}, ncol=3)
plt.xlim([0, 37])
plt.ylim([-3, 3.5])
